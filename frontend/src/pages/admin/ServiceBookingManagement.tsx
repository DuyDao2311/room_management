                  ...
                  {bookings.map((b) => (
                    ...
                    >
                      ...
                      <td style={{ padding: "16px 24px" }}>
                        ...
                        <div
                          style={{
                            fontSize: "0.8rem",
                            fontWeight: 600,
                            color: PAYMENT_MAP[b.paymentStatus]?.color,
                          }}
                        >
                      ...
                      <td style={{ padding: "16px 24px" }}>
                        <span
                          style={{
                            background: STATUS_MAP[b.status]?.bg,
