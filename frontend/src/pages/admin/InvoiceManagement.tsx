...
const DateInput = ({ value, onChange, placeholder, style }: any) => {
  ...
  const displayValue =
    type === "text" && value ? value.split("-").reverse().join("/") : value;
...
export default function InvoiceManagement() {
  ...
  const extraCost = form.extraFees.reduce(
  ...
  const handleRowClick = (inv: Invoice) => {
    ...
    setForm({
      ...
      extraFees: (inv.extraFees || []).map((f, i) => ({
        id: i,
        name: f.name,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setFormError("");
    if (!form.contractId) {
      setFormError("Vui lòng chọn hợp đồng.");
      return;
    }
    if (form.type === "service") {
      if (!form.elecOld || !form.elecNew) {
        setFormError("Vui lòng nhập đầy đủ chỉ số điện.");
        return;
      }
      if (!form.waterOld || !form.waterNew) {
    ...
    try {
      if (view === "edit" && editingId) {
        if (form.type === "deposit") {
          ...
          const extraFees = form.extraFees
          ...
          await api.put(`/invoices/${editingId}`, {
            ...
            year: form.year,
            electricity: {
              oldReading: Number(form.elecOld),
              newReading: Number(form.elecNew),
              rate: Number(form.elecRate),
            },
            water: {
              oldReading: Number(form.waterOld),
              newReading: Number(form.waterNew),
            ...
            >
              <div
                ...
                style={{
                  ...
                  cursor: "pointer",
                  transition: "all 0.2s",
                  transform: filterStatus === "" ? "translateY(-2px)" : "none",
                  border:
                    filterStatus === ""
                      ? "1px solid #003e68"
                      : "1px solid #eaecf0",
              ...
              <div
                ...
                style={{
                  ...
                  transition: "all 0.2s",
                  transform:
                    filterStatus === "paid" ? "translateY(-2px)" : "none",
                  border:
                    filterStatus === "paid"
                      ? "1px solid #003e68"
                      : "1px solid #eaecf0",
              ...
              >
                ...
                >
                  ...
                  {stats.totalInvoices > 0
                    ? ((stats.paid / stats.totalInvoices) * 100).toFixed(0)
                    : 0}
                  % hoàn thành
                </div>
              </div>
              ...
              <div
                ...
                style={{
                  ...
                  transition: "all 0.2s",
                  transform:
                    filterStatus === "pending" ? "translateY(-2px)" : "none",
                  border:
              ...
              <div
                ...
                style={{
                  ...
                  transition: "all 0.2s",
                  transform:
                    filterStatus === "overdue" ? "translateY(-2px)" : "none",
                  border:
              ...
              >
                ...
                >
                  {stats.expectedRevenue.toLocaleString("vi-VN")}đ
                </div>
                <div
                  style={{
                    fontSize: "0.75rem",
                      ...
                      >
                        ...
                        <td>
                          <Badge
                            ...
                            variant={
                              STATUS_MAP[inv.status]?.variant || "neutral"
                            }
                          />
                        </td>
                        <td
                                ...
                                style={{
                                  ...
                                  cursor:
                                    confirmingId === inv._id
                                      ? "not-allowed"
                                      : "pointer",
                                  opacity: confirmingId === inv._id ? 0.7 : 1,
                                }}
      ...
      <div className="invoice-header">
        <div>
          <h1 className="invoice-title">
            {view === "edit" ? "Chi tiết hóa đơn" : "Tạo hóa đơn"}
          </h1>
          <p className="invoice-subtitle">
            {view === "edit" && isSent
              ? "Hóa đơn đã gửi, không thể chỉnh sửa."
              : "Hóa đơn dịch vụ hàng tháng hoặc tiền cọc."}
          </p>
        </div>
        <button
          type="button"
        ...
        >
          ...
          <div className="invoice-section">
            <div className="invoice-section-title">
              <FiInfo size={20} /> Thông tin cơ bản
            </div>

            <div style={{ display: "flex", gap: "24px" }}>
              <div
                className="invoice-input-group"
                style={{ flex: 1 }}
              >
              ...
              >
                ...
                <select
                  ...
                  onChange={(e) => sf("contractId", e.target.value)}
                  required
                  disabled={view === "edit"}
                >
                  ...
                  {contracts.map((c) => (
                    <option
                      ...
                      value={c._id}
                    >
                      HĐ: {c.representativeName || c.tenant?.name} -{" "}
                      {c.room?.name}
                    </option>
                  ))}
                </select>
            ...
            {selectedContract && (
              <div className="invoice-info-box">
                ...
                >
                  ...
                  <span
                    className="invoice-info-val"
                    style={{ color: "#0f5cc7" }}
                  >
                    {selectedContract.monthlyRent?.toLocaleString("vi-VN")} đ
                  </span>
                </div>
              </div>
            )}
          ...
          {form.type === "deposit" ? (
            <div className="invoice-section">
              <div className="invoice-section-title">
                <MdReceiptLong size={20} /> Chi tiết tiền cọc
              </div>
              ...
              >
                ...
                >
                  {rentCost.toLocaleString("vi-VN")} đ
                </span>
              </div>
              <div
                style={{
              ...
              >
                <div>
                  ...
                  >
                    Bao gồm tiền phòng và tiền cọc
                  </div>
                </div>
            ...
            <div className="invoice-section">
              ...
              >
                <div
                  ...
                  style={{ margin: 0 }}
                >
                  <FiZap size={20} /> Chi tiết dịch vụ
                </div>
                <div
                ...
                >
                  ...
                  <select
                    ...
                    value={form.month}
                    onChange={(e) => sf("month", Number(e.target.value))}
                  >
                  ...
                  <input
                    ...
                    value={form.year}
                    onChange={(e) => sf("year", Number(e.target.value))}
                  />
                </div>
              </div>
              ...
              <div className="invoice-row row-elec">
                ...
                <div style={{ width: "180px" }}>
                  ...
                  <div className="invoice-row-desc">
                    <input
                      ...
                      value={form.elecRate}
                      onChange={(e) => sf("elecRate", e.target.value)}
                    />{" "}
                    đ / kWh
                  </div>
                </div>
                ...
                >
                  <div className="invoice-input-group">
                    <label className="invoice-input-label">Chỉ số cũ</label>
                    <input
                      className="invoice-input"
                      type="number"
                      min={0}
                      value={form.elecOld}
                      onChange={(e) => sf("elecOld", e.target.value)}
                      required
                    />
                  </div>
                  <span style={{ color: "#9ca3af", marginTop: "20px" }}>-</span>
                  <div className="invoice-input-group">
                    <label className="invoice-input-label">Chỉ số mới</label>
                    <input
                      className="invoice-input"
                      type="number"
                      min={0}
                      value={form.elecNew}
                      onChange={(e) => sf("elecNew", e.target.value)}
                      required
                    />
                  </div>
                </div>
                ...
                >
                  <span className="invoice-input-label">Sử dụng</span>
                  <span
                    style={{
                      fontSize: "1rem",
                      fontWeight: 600,
                ...
                >
                  <span className="invoice-input-label">Thành tiền</span>
                  <span
                    style={{
                      fontSize: "1.1rem",
                      fontWeight: 700,
                ...
                <div style={{ width: "180px" }}>
                  ...
                  <div className="invoice-row-desc">
                    <input
                      ...
                      onChange={(e) => sf("waterRate", e.target.value)}
                    />{" "}
                    đ / khối
                  </div>
                </div>
                ...
                >
                  <div className="invoice-input-group">
                    ...
                    <input
                      ...
                      min={0}
                      value={form.waterOld}
                      onChange={(e) => sf("waterOld", e.target.value)}
                      required
                    />
                  </div>
                  <span style={{ color: "#9ca3af", marginTop: "20px" }}>-</span>
                  <div className="invoice-input-group">
                    ...
                    <input
                      ...
                      min={0}
                      value={form.waterNew}
                      onChange={(e) => sf("waterNew", e.target.value)}
                      required
                    />
                  </div>
                </div>
              ...
              {/* Phí khác */}
              <div
                className="invoice-row row-other"
              ...
              >
                ...
                >
                  <div
                    className="invoice-icon-box"
                    style={{ height: 36, width: 36, fontSize: "1rem" }}
                  >
                    <MdReceiptLong />
                  </div>
                  <div
                ...
                {form.extraFees.map((fee) => (
                  ...
                  >
                    <input
                      className="text-left invoice-input"
                      placeholder="Tên phí (vd: Phí quản lý)"
                      value={fee.name}
                      onChange={(e) =>
                    ...
                    <input
                      ...
                      value={fee.amount}
                      onChange={(e) =>
                        handleUpdateFee(fee.id, "amount", e.target.value)
                      }
                      required
                    />
              ...
              <div
                className="form-group"
                style={{ maxWidth: 280, marginTop: 16, marginBottom: 16 }}
              >
                <label
                  style={{
                    fontWeight: 600,
              ...
              >
                <div className="invoice-summary-lines">
                  <div className="invoice-summary-line">
                    ...
                    <strong>{rentCost.toLocaleString("vi-VN")} đ</strong>
                  </div>
                  <div className="invoice-summary-line">
                    <span>Điện &amp; Nước:</span>
                    <strong>{(eCost + wCost).toLocaleString("vi-VN")} đ</strong>
                  </div>
                  <div className="invoice-summary-line">
                    <span>Phí khác:</span>
